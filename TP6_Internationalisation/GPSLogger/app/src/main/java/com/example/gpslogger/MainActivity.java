    ...
    public class MainActivity extends AppCompatActivity {
        ...
        private final LocationListener locationListener = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location location) {
                ...
                tvLatitude.setText(getString(R.string.latitude) );
                tvLongitude.setText(getString(R.string.longitude) );
                tvAltitude.setText(getString(R.string.altitude) );
                tvSignalStrength.setText(getString(R.string.signal_strength) );
                tvBatteryLevel.setText(getString(R.string.battery_level) );
            }
        };
        ...
        private void showFileLocation() {
            ...
            TextView tvFileLocation = findViewById(R.id.tvFileLocation);
